...
game.StarterGui:SetCore("ChatMakeSystemMessage", {
    Text = "[ System ] LeanHub is loading please wait.";
})
...
local Window = Rayfield:CreateWindow({
    Name = "LeanHub | Demon Soul Simulator",
    LoadingTitle = "LeanHub | Demon Soul Simulator",
    LoadingSubtitle = "By: DX9UserMental#6238",
    ConfigurationSaving = {
		Enabled = true,
		FolderName = "LeanHub",
